        ...
        for widget in widgets:
            ...
            if "command_box" in widget:
                ...
                elements.append(html.Div([
                    ...
                    dcc.Input(
                        id={"type": "command-box", "instrument": instrument_name, "name": label, "command_queue_name": command_queue_name},
                        type="text",
...
def instrument_controls(app, sqlengine, config): 
    ...
    @app.callback(
        ...
        [
            ...
            Input({"type": "command-box", "instrument": dash.ALL, "name": dash.ALL,  "command_queue_name": dash.ALL}, "value"),
        ],
    )
